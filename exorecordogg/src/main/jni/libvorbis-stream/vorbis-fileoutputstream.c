 ...
 */
jint Java_dev_brookmg_exorecordogg_VorbisFileOutputStream_create(
        JNIEnv* env,
        jobject this,
        jstring path,
        jobject info
 ...
 *
 */
jint Java_dev_brookmg_exorecordogg_VorbisFileOutputStream_writeStreamIdx(
        JNIEnv* env,
        jobject this,
        jint sidx,
        jshortArray pcm,
 ...
 */
void Java_dev_brookmg_exorecordogg_VorbisFileOutputStream_closeStreamIdx(
        JNIEnv* env,
        jobject this,
        jint sidx
        )
