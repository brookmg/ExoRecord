...
JNIEXPORT jint Java_org_xiph_vorbis_stream_VorbisFileInputStream_create(
		JNIEnv* env,
		jobject this,
		jstring path,
		jobject info
...
JNIEXPORT jint Java_org_xiph_vorbis_stream_VorbisFileInputStream_readStreamIdx(
		JNIEnv* 	env,
		jobject 	this,
		jint		sidx,
		jshortArray pcm,
...
JNIEXPORT jlong Java_org_xiph_vorbis_stream_VorbisFileInputStream_skipStreamIdx(
		JNIEnv* 	env,
		jobject 	this,
		jint		sidx,
		jlong 		offset
...
JNIEXPORT void Java_org_xiph_vorbis_stream_VorbisFileInputStream_closeStreamIdx(
		JNIEnv* 	env,
		jobject 	this,
		jint		sidx
		)
